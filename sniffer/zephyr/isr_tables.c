...
struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0xa949, (ISR)0x108af}, /* 13 */
	...
	{(const void *)0xab91, (ISR)0x108af}, /* 42 */
